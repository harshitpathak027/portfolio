...
const Qualifications = () => {
    ...
    return (
                ...
                <div className="flex  gap-4 justify-center text-center">
                    ...
                    <div className={`flex items-center justify-center text-xl md:text-3xl cursor-pointer  gap-2  `} onClick={() => { setSelectedTab("Education") }} >
                        <svg xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 24 24" className={`h-8 w-8 ${selectedTab === "Education"
                                    ? "text-orange-500"
                                    : darkMode
                                        ? "text-white"
                                        : "text-black"
        ...
        "
              ...
              "
                        >
                            <h3 className="font-bold">{selectedTab === "Experience" && "Software Engineer"}</h3>
                            <p>{selectedTab === "Experience" && "LTM"}</p>
                            <span className="text-sm text-gray-600">{selectedTab === "Experience" && "Feb 2026 - Present"}</span>
                        </div>
                    {/* LEFT */}
                    <div
                        className="
          ...
          "
                    >
                        ...
                        <span className="text-sm text-gray-500">{selectedTab === "Education" ? "2020-2024" : "Oct-2024 - Feb 2026"}</span>
                    </div>
